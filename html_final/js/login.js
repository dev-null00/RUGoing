	...
	$("#status > form").submit(function(){  
		...
		$.ajax({  
				...
				$("#status").ajaxComplete(function(event, request, settings){  
					...
					//alert(msg);
					//var result=msg;
					var result=msg.getElementsByTagName('loginResult')[0].firstChild.nodeValue.replace(/^\s*|\s*$/g,'');
					//alert(result);
 					...
 					{  
 						var login_response = "Incorrect Username/Password";
